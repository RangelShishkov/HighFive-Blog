...
const fetchPost = async () => {
  const res = await axios.get(
    `${import.meta.env.VITE_API_URL}/posts?featured=true&limit=4&sprt=newest`
  );
  return res.data;
};
    ...
    <div className="mt-8 flex flex-col lg:flex-row gap-8">
      ...
      <div className="w-full lg:w-1/2 flex flex-col gap-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link className="text-red-600 lg:text-lg">{posts[0].category}</Link>
          ...
          <div className="lg:h-1/3 flex justify-between gap-4 ">
            ...
            <div className="w-2/3">
              <div className="flex items-center gap-4 text-sm lg:text-base mb-4">
                ...
                <Link className="text-red-600">{posts[1].category}</Link>
          ...
          <div className="lg:h-1/3 flex justify-between gap-4 ">
            ...
            <div className="w-2/3">
              <div className="flex items-center gap-4 text-sm lg:text-base mb-4">
                ...
                <Link className="text-red-600">{posts[2].category}</Link>
          ...
          <div className="lg:h-1/3 flex justify-between gap-4 ">
            ...
            <div className="w-2/3">
              <div className="flex items-center gap-4 text-sm lg:text-base mb-4">
                ...
                <Link className="text-red-600">{posts[3].category}</Link>
